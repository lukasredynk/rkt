...
func GetAppsResources(apps schema.AppList) (totalCpus, totalMem int64) {
	...
	if !cpusSpecified || totalCpus > available_cpus {
		totalCpus = available_cpus
	}
...
// GetAppCapabilities is a filter which returns list of valid Linux capabilities
// Function requires a manifest of application
